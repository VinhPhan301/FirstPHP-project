...
<body style="width: 60%; margin: 0 auto;">
    ...
    <h2 style="color:#27313a">Chúng tôi thành thật tiếc nuối báo tin đơn hàng CNF-DH-{{ $order->id }} của quý khách đã bị hủy.</h2>
    <h3 style="color:#27313a">Đây là sự cố ngoài mong muốn và chúng tôi mong rằng bạn sẽ tiếp tục đồng hành cùng chúng tôi trong tương lai.</h3>
    <div style="
    padding: 10px 20px;
