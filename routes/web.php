...
Route::prefix('admin')->group(function () {
    ...
    Route::prefix('/user')->group(function () {
        ...
        Route::get('/search', [UserController::class, 'userSearch'])->name('user.search')->middleware('checkRole');
        Route::get('/searchName', [UserController::class, 'userSearchName'])->name('user.searchName')->middleware('checkRole');
    });
    ...
    Route::prefix('order')->group(function () {
        ...
        Route::get('/update', [OrderController::class, 'updateCancel'])->name('order.update');
...
Route::prefix('/')->group(function () {
    ...
    Route::get('/search', [ShopController::class, 'searchProduct'])->name('shop.searchProduct');
    ...
    Route::get('/checkoutSuccess', [OrderController::class, 'returnMainPage']);
});
